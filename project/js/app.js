...
async function loadDetail() {
  ...
  try {
    ...
    div.innerHTML = `
      ...
      <h3>好み</h3>
      <div>
      <li class="normal-list">好きな物・事：　${good1 || 'なし'}</li>
      <li class="normal-list">嫌いな物・事：　${bad1 || 'なし'}</li>
      </div>
      <h3>人間関係</h3>
      <div>
      <li class="normal-list">仲良い人 ／ 好きなタイプ：　${good || 'なし'}</li>
      <li class="normal-list">仲悪い人 ／ 嫌いなタイプ：　${bad || 'なし'}</li>
      </div>
